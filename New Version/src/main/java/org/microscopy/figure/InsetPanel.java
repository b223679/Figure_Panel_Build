...
public class InsetPanel extends JPanel implements Scrollable {
  ...
  public InsetPanel(FigureConfiguration config, InputImageManager inputs, Runnable changed) {
    ...
    JPanel customSize = group();
    customSize.setBorder(BorderFactory.createEmptyBorder());
    JPanel zoom = group();
    ...
    magnification.setPreferredSize(new Dimension(58, 24));
  ...
  private void line(JPanel parent, String text, JComponent control) {
    ...
    label.setPreferredSize(new Dimension(84, 28));
  ...
  private <T> void choice(
    ...
    combo.setName(name);
    combo.setPreferredSize(new Dimension(92, 24));
    line(p, text, combo);
